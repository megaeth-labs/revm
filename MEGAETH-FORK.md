...
A pick that touches a precompile is tested under each crypto backend the crate offers (the portable path, `blst`, and all features), not only the default feature set.

...
## [21.0.0](https://github.com/megaeth-labs/revm/compare/revm-handler-v20.0.3...revm-handler-v21.0.0) - 2026-09-08
...
- propagate InitialAndFloorGas to validate_against_state_and_deduct_caller ([#3577](https://github.com/megaeth-labs/revm/pull/3577))
...
- in JumpTable use Bytes instead of BitVec ([#3014](https://github.com/megaeth-labs/revm/pull/3014))
...
- fix renamed functions for system_call ([#2824](https://github.com/megaeth-labs/revm/pull/2824))
- Align naming of SystemCallEvm function to ExecuteEvm ([#2814](https://github.com/megaeth-labs/revm/pull/2814))
...
- add with_caller for system_transact ([#2587](https://github.com/megaeth-labs/revm/pull/2587))
...
- system_call switch order of inputs, address than bytes ([#2485](https://github.com/megaeth-labs/revm/pull/2485))
...
- remove spec id verification on `apply_eip7702_auth_list` ([#2466](https://github.com/megaeth-labs/revm/pull/2466))
...
- provide more context to precompiles ([#2318](https://github.com/megaeth-labs/revm/pull/2318))
...
- decouple first_frame_input from inspector ([#2180](https://github.com/megaeth-labs/revm/pull/2180))
- *(handler)* add MainnetContext alias generic over Database ([#2166](https://github.com/megaeth-labs/revm/pull/2166))
...
- removed create address collision check ([#1928](https://github.com/megaeth-labs/revm/pull/1928))
...
- *(precompile)* halt with PrecompileOOG when precompile over-spends gas ([#3639](https://github.com/megaeth-labs/revm/pull/3639))
- re-add PrecompileOutput::gas_refunded ([#3574](https://github.com/megaeth-labs/revm/pull/3574))
- *(handler)* skip reimburse_caller and reward_beneficiary when fee charge is disabled ([#3559](https://github.com/megaeth-labs/revm/pull/3559))
- reject transactions with nonce at u64::MAX ([#3553](https://github.com/megaeth-labs/revm/pull/3553))
- *(handler)* respect is_fee_charge_disabled in calculate_caller_fee ([#3401](https://github.com/megaeth-labs/revm/pull/3401))
...
- interpreter_result_mut should return mutable reference ([#2941](https://github.com/megaeth-labs/revm/pull/2941))
- FrameStack mark push/end_init as unsafe ([#2929](https://github.com/megaeth-labs/revm/pull/2929))
- nonce changed is not reverted in journal if fail due to insufficient balance ([#2805](https://github.com/megaeth-labs/revm/pull/2805))
- fully deprecate serde-json ([#2767](https://github.com/megaeth-labs/revm/pull/2767))
- system call should have 30M gas limit ([#2755](https://github.com/megaeth-labs/revm/pull/2755))
...
- *(op)* bump nonce on deposit ([#2503](https://github.com/megaeth-labs/revm/pull/2503))
- *(eof)* extdelegate bytecode check after eip7702 load ([#2417](https://github.com/megaeth-labs/revm/pull/2417))
...
- broken disable balance check ([#2286](https://github.com/megaeth-labs/revm/pull/2286))
- *(op)* fix inspection call ([#2184](https://github.com/megaeth-labs/revm/pull/2184))
...
- call clear ([#2091](https://github.com/megaeth-labs/revm/pull/2091))
- *(Inspector)* frame_end called multiple times ([#2037](https://github.com/megaeth-labs/revm/pull/2037))
- *(Inspector)* call handler functions ([#2026](https://github.com/megaeth-labs/revm/pull/2026))
- deduplicate validate_initial_tx_gas API ([#2006](https://github.com/megaeth-labs/revm/pull/2006))
...
- Revert "refactor: use `Cow` for warm precompile addresses ([#3652](https://github.com/megaeth-labs/revm/pull/3652))" ([#3653](https://github.com/megaeth-labs/revm/pull/3653))
- use `Cow` for warm precompile addresses ([#3652](https://github.com/megaeth-labs/revm/pull/3652))
...
- *(handler)* rename misleading `underflow` variable to `success` ([#3486](https://github.com/megaeth-labs/revm/pull/3486))
...
- *(handler)* remove Default for EthPrecompiles and EthInstructions ([#3434](https://github.com/megaeth-labs/revm/pull/3434))
- remove unused alloy-provider dev-dependency ([#3423](https://github.com/megaeth-labs/revm/pull/3423))
...
- *(revm-handler)* add ItemOrResult::map_item (alias map_frame) ([#3320](https://github.com/megaeth-labs/revm/pull/3320))
...
- description of `Handler::validate_against_state_and_deduct_caller` should match responsibilities ([#3256](https://github.com/megaeth-labs/revm/pull/3256))
- *(handler)* eliminate code duplication in transaction validation ([#3243](https://github.com/megaeth-labs/revm/pull/3243))
- *(handler)* validate_initial_tx_gas takes &mut Evm  ([#3235](https://github.com/megaeth-labs/revm/pull/3235))
...
- apply_auth_list helper fn ([#3187](https://github.com/megaeth-labs/revm/pull/3187))
...
- *(op)* use helper function in validate against state ([#3069](https://github.com/megaeth-labs/revm/pull/3069))
- remove redundant alloy-eip7702 from handler dev-dependencies ([#3105](https://github.com/megaeth-labs/revm/pull/3105))
...
- *(handler)* extract duplicate gas price validation ([#3045](https://github.com/megaeth-labs/revm/pull/3045))
...
- helper calculate_caller_fee ([#3040](https://github.com/megaeth-labs/revm/pull/3040))
...
- Frame use From in place of Into ([#3036](https://github.com/megaeth-labs/revm/pull/3036))
- EvmTr and InspectorEvmTr receive all/all_mut fn ([#3037](https://github.com/megaeth-labs/revm/pull/3037))
...
- Fix infinite recursion in EthPrecompiles PrecompileProvider methods ([#2962](https://github.com/megaeth-labs/revm/pull/2962))
- add SECURITY.md ([#2956](https://github.com/megaeth-labs/revm/pull/2956))
- update `EthFrame::invalid` visibility ([#2947](https://github.com/megaeth-labs/revm/pull/2947))
- remove unused generic from validate_tx_env and fix call site ([#2946](https://github.com/megaeth-labs/revm/pull/2946))
- cargo update ([#2930](https://github.com/megaeth-labs/revm/pull/2930))
- *(handler)* provide `&CallInputs`to`PrecompileProvider::run` ([#2921](https://github.com/megaeth-labs/revm/pull/2921))
...
- rm commented code ([#2839](https://github.com/megaeth-labs/revm/pull/2839))
...
- fix run-tests.sh ([#2801](https://github.com/megaeth-labs/revm/pull/2801))
...
- change gas parameter to immutable reference ([#2702](https://github.com/megaeth-labs/revm/pull/2702))
- remove State bound from JournalTr in Handler::Evm ([#2715](https://github.com/megaeth-labs/revm/pull/2715))
...
- document external state transitions for EIP-4788 and EIP-2935 ([#2678](https://github.com/megaeth-labs/revm/pull/2678))
- minor fixes ([#2686](https://github.com/megaeth-labs/revm/pull/2686))
- fix in pre_execution.rs about nonce bump for CREATE ([#2684](https://github.com/megaeth-labs/revm/pull/2684))
...
- *(op)* revert previous and localize fix ([#2504](https://github.com/megaeth-labs/revm/pull/2504))
...
- Add clones to FrameData ([#2482](https://github.com/megaeth-labs/revm/pull/2482))
...
- remove outdated TODO comments ([#2325](https://github.com/megaeth-labs/revm/pull/2325))
- add EIP-170 contract code size limit tests ([#2312](https://github.com/megaeth-labs/revm/pull/2312))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/megaeth-labs/revm/pull/2299))
- add unit test for EIP-3860 initcode size limit ([#2302](https://github.com/megaeth-labs/revm/pull/2302))
...
- add debug to precompiles type ([#2193](https://github.com/megaeth-labs/revm/pull/2193))
...
- remove CTX phantomdata from precompile providers ([#2178](https://github.com/megaeth-labs/revm/pull/2178))
...
- op-revm cleanup and few docs ([#2156](https://github.com/megaeth-labs/revm/pull/2156))
...
- remove unused source file ([#2133](https://github.com/megaeth-labs/revm/pull/2133))
...
- relax trait req in EthPrecompiles::default ([#2071](https://github.com/megaeth-labs/revm/pull/2071))

...
pub fn eval<H: Host, S: Spec>(
    ...
    match opcode {
        ...
        opcode::ADDMOD => arithmetic::addmod(interp, host),
        opcode::MULMOD => arithmetic::mulmod(interp, host),
        opcode::EXP => arithmetic::eval_exp::<S>(interp, host, gas_used),
        opcode::SIGNEXTEND => arithmetic::signextend(interp, host),
        opcode::LT => bitwise::lt(interp, host),
        opcode::GT => bitwise::gt(interp, host),
        opcode::SLT => bitwise::slt(interp, host),
        ...
        opcode::SHR => bitwise::shr::<S>(interp, host),
        opcode::SAR => bitwise::sar::<S>(interp, host),
        opcode::SHA3 => system::sha3(interp, host, gas_used),
        opcode::ADDRESS => system::address(interp, host),
        opcode::BALANCE => host::balance::<S>(interp, host, gas_used),
        opcode::SELFBALANCE => host::selfbalance::<S>(interp, host),
        opcode::CODESIZE => system::codesize(interp, host),
        opcode::CODECOPY => system::codecopy(interp, host, gas_used),
        opcode::CALLDATALOAD => system::calldataload(interp, host),
        opcode::CALLDATASIZE => system::calldatasize(interp, host),
        opcode::CALLDATACOPY => system::calldatacopy(interp, host, gas_used),
        opcode::POP => stack::pop(interp, host),
        opcode::MLOAD => memory::mload(interp, host),
        opcode::MSTORE => memory::mstore(interp, host),
        opcode::MSTORE8 => memory::mstore8(interp, host),
        ...
        opcode::CALLVALUE => system::callvalue(interp, host),
        opcode::GASPRICE => host_env::gasprice(interp, host),
        opcode::EXTCODESIZE => host::extcodesize::<S>(interp, host, gas_used),
        opcode::EXTCODEHASH => host::extcodehash::<S>(interp, host, gas_used),
        opcode::EXTCODECOPY => host::extcodecopy::<S>(interp, host, gas_used),
        opcode::RETURNDATASIZE => system::returndatasize::<S>(interp, host),
        opcode::RETURNDATACOPY => system::returndatacopy::<S>(interp, host, gas_used),
        opcode::BLOCKHASH => host::blockhash(interp, host),
        opcode::COINBASE => host_env::coinbase(interp, host),
        opcode::TIMESTAMP => host_env::timestamp(interp, host),
        opcode::NUMBER => host_env::number(interp, host),
        opcode::DIFFICULTY => host_env::difficulty::<H, S>(interp, host),
        opcode::GASLIMIT => host_env::gaslimit(interp, host),
        opcode::SLOAD => host::sload::<S>(interp, host, gas_used),
        opcode::SSTORE => host::sstore::<S>(interp, host, gas_used, gas_refund),
        opcode::GAS => system::gas(interp, host),
        opcode::LOG0 => host::log::<0>(interp, host, gas_used),
        opcode::LOG1 => host::log::<1>(interp, host, gas_used),
        opcode::LOG2 => host::log::<2>(interp, host, gas_used),
        opcode::LOG3 => host::log::<3>(interp, host, gas_used),
        opcode::LOG4 => host::log::<4>(interp, host, gas_used),
        opcode::SELFDESTRUCT => host::selfdestruct::<S>(interp, host, gas_used, gas_refund),
        opcode::CREATE => host::create::<false, S>(interp, host, gas_used, gas_refund), //check
        opcode::CREATE2 => host::create::<true, S>(interp, host, gas_used, gas_refund), //check
        opcode::CALL => host::call::<S>(interp, host, gas_used, gas_refund),            //check
        opcode::CALLCODE => host::call_code::<S>(interp, host, gas_used, gas_refund),   //check
        opcode::DELEGATECALL => host::delegate_call::<S>(interp, host, gas_used, gas_refund), //check
        opcode::STATICCALL => host::static_call::<S>(interp, host, gas_used, gas_refund), //check
        opcode::CHAINID => host_env::chainid::<S>(interp, host),
        _ => return_not_found(interp, host),
    }
}
